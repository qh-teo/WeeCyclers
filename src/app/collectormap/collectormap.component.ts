...
@Component({
  selector: 'collector-map',
  templateUrl: './collectormap.component.html',
  styleUrls: ['./collectormap.component.scss'],
})

export class CollectormapComponent extends LatLonEllipsoidal{
  π: any = Math.PI;
  ...
  public async ngAfterViewInit() {
    ...
    this.http.get(url).subscribe(data => {
      ...
      for(var i = 0; i < Object.keys(data).length; i++){       
        ...
        var dRAmt = data[i].RecyclableAmt;
